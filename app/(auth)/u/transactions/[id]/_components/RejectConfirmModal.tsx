    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        <p className="mb-4 text-sm text-gray-500">
          Are you sure you want to reject this investment entry?
        </p>
        <div className="mb-4 space-y-2 rounded-lg border border-gray-200 bg-gray-50/50 p-4 text-sm">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading ? (
              <>
